...
router.get('/', verifyToken, hasRole(['admin_general']), notificacionController.getAllNotificaciones);
...
router.post('/', verifyToken, hasRole(['admin_general']), notificacionController.createNotificacion);
